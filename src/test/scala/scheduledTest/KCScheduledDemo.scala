...
// class KCScheduledDemo extends Simulation{

//     // Number of login requests to simulate on execution
//     val numberOfLogins = 750
...
//         NOTE: Need to manually add test results at following link: https://asbscr.ic.gc.ca/scm/projects/ISEDPLATFORM/repos/keycloak-extensions/browse
//     **/
...
//      val httpConfig = http
//      .proxy(Proxy("cdhwg01.prod.prv", 80))
//         .baseUrl("https://sso-demo.ised-isde.canada.ca")
